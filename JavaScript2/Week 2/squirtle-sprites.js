...
const pokemones = fetchPokemonData();
// console.log(pokemones);


const pokemoneData = JSON.parse(pokemones);
console.log(pokemoneData);


let pokemoneSprites = Object.values(pokemoneData.sprites);
let pokemoneImages = pokemoneSprites.filter( (e) => {
  return e != null;
} )
console.log(pokemoneSprites);


let pokemonImagesShow = pokemoneSprites.map( (e) => {
